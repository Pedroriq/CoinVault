...
class Parcelas(models.Model):
    ...
    max_portion = models.PositiveSmallIntegerField(
...
class Gastos(models.Model):
    ...
    type = models.CharField(
        max_length=50, choices=TYPE_CHOICES, verbose_name="Tipo de Gastos"
    )
    ...
    parcelas_id = models.ForeignKey(
        Parcelas, on_delete=models.SET_NULL, null=True
    )
